...
const Items = (props) => {
   return (
      ...
      //         <div classNameName="absolute inset-0 bg-black bg-opacity-40 flex items-center 
      // justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
      //             <a href="#"
      //                 classNameName="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition"
      //                 title="view product">
      ...
      //         </div>
      //     </div>
      //     <div classNameName="pt-4 pb-3 px-4">
      //         <a href="#">
      //             <h4 classNameName="uppercase font-medium text-xl mb-2 text-gray-800 hover:text-primary transition truncate truncate-line-1">{props.product.title}</h4>
      //         </a>
      //         <div classNameName="flex items-baseline mb-1 space-x-2">
      //             <p classNameName="text-xl text-primary font-semibold">${props.product.price}</p>
      //             <p classNameName="text-sm text-gray-400 line-through">$55.90</p>
      //         </div>
      //         <div classNameName="flex items-center">
      //             <div classNameName="flex gap-1 text-sm text-yellow-400">
      //                 <span><i classNameName="fa-solid fa-star"></i></span>
      //                 <span><i classNameName="fa-solid fa-star"></i></span>
      //                 <span><i classNameName="fa-solid fa-star"></i></span>
      //                 <span><i classNameName="fa-solid fa-star"></i></span>
      //                 <span><i classNameName="fa-solid fa-star"></i></span>
      //             </div>
      //             <div classNameName="text-xs text-gray-500 ml-3">(150)</div>
      //         </div>
      //     </div>
      //     <a href="#"
      ...
      <div class="item">
         <div class="product-cart-three w-full group">
                  ...
                  <a href="#">
                     <span class="w-10 h-10 flex justify-center items-center bg-gray-200 rounded">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path d="M0.339844 3.18947V5.71272H0.991007H1.64217V4.31815V2.91815L4.6538 5.92978L7.66543 8.94141L8.13752 8.46389L8.61504 7.99179L5.60341 4.98017L2.59178 1.96854H3.99178H5.38636V1.31737V0.66621H2.8631H0.339844V3.18947Z" fill="black"></path>
                           <path d="M13.9592 1.31737V1.96854H15.3537H16.7537L13.7421 4.98017L10.7305 7.99179L11.208 8.46389L11.6801 8.94141L14.6917 5.92978L17.7033 2.91815V4.31815V5.71272H18.3545H19.0057V3.18947V0.66621H16.4824H13.9592V1.31737Z" fill="black"></path>
            ...
            <Link to={`/product/${props.product.id}`}>
               <h2 class="text-xl leading-6 font-medium text-qblack mb-2">{props.product.title}</h2></Link>
